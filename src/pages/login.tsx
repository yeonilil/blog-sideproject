...
export default function Login() {
  ...
  return (
    <Wrapper>
      {" "}
      <div className="flex flex-col items-center w-screen h-screen bg-custom-gradient pt-[100px]">
        <Link href="/main">
          <Image
            src="../assets/logo.svg"
            alt="logo"
        ...
        <form className="flex flex-col">
          ...
          <button
            ...
            className="w-[300px] h-[50px] bg-black-400 text-white rounded-[10px] md:w-[500px] mt-[50px]"
          >
            LOGIN
          </button>
          <div className="flex justify-center mt-[20px]">
            ...
            <Link href="/signup">
              <p className="hover:text-blue-500 text-[14px]">회원가입</p>
            </Link>
          </div>
        </form>
      </div>
